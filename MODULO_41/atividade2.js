...
function preload() {
  ...
  a1 = loadImage("../RECURSOS/IMAGENS/frase1.png");
  a2 = loadImage("../RECURSOS/IMAGENS/frase2.png");
  a3 = loadImage("../RECURSOS/IMAGENS/frase3.png");
  a4 = loadImage("../RECURSOS/IMAGENS/frase4.png");
  a5 = loadImage("../RECURSOS/IMAGENS/frase5.png");
  a6 = loadImage("../RECURSOS/IMAGENS/frase6.png");
  a7 = loadImage("../RECURSOS/IMAGENS/frase7.png");
  a8 = loadImage("../RECURSOS/IMAGENS/frase8.png");
  a9 = loadImage("../RECURSOS/IMAGENS/frase9.png");
  a10 = loadImage("../RECURSOS/IMAGENS/frase10.png");

  bkgImg = loadImage("../RECURSOS/IMAGENS/mod4-rec2.png");
...
function setup() {
  ...
  posInput = createVector((innerWidth / 12) * 4.8, (innerHeight / 9.4) * 7); //botao
...
class Bloco {
  ...
  constructor(imagem, silabas, erradas, certas, palavra) {
    ...
    this.posImagem = createVector(17*(innerWidth / 80), 20*(innerHeight / 80)); //imagem
